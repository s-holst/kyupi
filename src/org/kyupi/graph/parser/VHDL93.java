...
public class VHDL93 implements VHDL93Constants {
        ...
        public static ArrayList<Graph> parse (InputStream is, Library library) throws IOException {
            String sf_ = "foo";
  ...
  final public void entity_declaration(Context c) throws ParseException {
        String id;
        Graph entity = new Graph(library);
  ...
  final public void entity_header(Graph entity_) throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case GENERIC:
      generic_clause();
      break;
  ...
  final public void port_clause(Graph entity_) throws ParseException {
  ...
  final public void interface_list(Graph entity_) throws ParseException {
  ...
  final public void interface_declaration(Graph entity_) throws ParseException {
    interface_signal_declaration(entity_);
  }

  final public void interface_signal_declaration(Graph entity_) throws ParseException {
  ...
  final public void architecture_declarative_part(Context c, Graph g) throws ParseException {
    label_14:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case ALIAS:
  ...
  final public void block_declarative_item(Context c, Graph g) throws ParseException {
  ...
  final public void architecture_statement_part(Graph arch_) throws ParseException {
    label_15:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case POSTPONED:
  ...
  final public void architecture_statement(Graph g) throws ParseException {
  ...
  final public void component_instantiation_statement(Graph g) throws ParseException {
  String id, compId;
  Node comp;
  HashMap<String,String> map;
    ...
    compId = instantiated_unit();
          comp=g.new Node(id,library.resolve(compId));
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case GENERIC:
      generic_map_aspect();
      break;
  ...
  final public void signal_declaration(Graph g) throws ParseException {
  ArrayList<String> ids;
    jj_consume_token(SIGNAL);
    ids = identifier_list();
    jj_consume_token(151);
    ...
    jj_consume_token(SEMICOLON);
          for (String id: ids)
          {
            ...
            g.new Node(id,Library.FLAG_PSEUDO|Library.TYPE_BUF);
          }
  }
